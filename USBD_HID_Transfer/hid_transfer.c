...
void EP2_Handler(void)  /* Data Gönderildiginde Bu Event Tetiklenir. */
{
  
}

void EP3_Handler(void)  /* IData Geldiginde Bu Event Olusur.*/
{
    uint8_t *pu8Ptr;
    pu8Ptr = (uint8_t *)(USBD_BUF_BASE + USBD_GET_EP_BUF_ADDR(EP3));
    Gelen_Data(pu8Ptr, USBD_GET_PAYLOAD_LEN(EP3));
...
void Veri_Gonder()
{
        ...
        s_au8TestPages[0]=12; // Veriler Bununla Gönderilir.
	       ...
	       s_au8TestPages[2]=14;
				s_au8TestPages[3]=15;       
        USBD_MemCopy((uint8_t *)(USBD_BUF_BASE + USBD_GET_EP_BUF_ADDR(EP2)), (void *)s_au8TestPages, 64);
