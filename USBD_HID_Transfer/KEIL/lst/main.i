...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(((((1) & 0x03) << 30)|((((27)) & 0x1f) << 0)| (((0) & 0x03) << 28)|(((1) & 0x07) << 25)|(((8) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0x0F) & 0xff) << 10)|(((4) & 0x1f) << 5)), (0x00UL<<(8)), (((1)-1) << (4)));
# 56 "../main.c"
    CLK_EnableModuleClock(((((1) & 0x03) << 30)|((((16)) & 0x1f) << 0)| (((1) & 0x03) << 28)|(((7) & 0x07) << 25)|(((24) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0x0F) & 0xff) << 10)|(((8) & 0x1f) << 5)));
    CLK_EnableModuleClock(((((1) & 0x03) << 30)|((((27)) & 0x1f) << 0)| (((0) & 0x03) << 28)|(((1) & 0x07) << 25)|(((8) & 0x1f) << 20)| (((0) & 0x03) << 18)|(((0x0F) & 0xff) << 10)|(((4) & 0x1f) << 5)));
...
void PowerDown()
{
    ...
    (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTEN |= ((0x1ul << (8))));

    CLK_PowerDown();


    if (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PWRCTL & (0x1ul << (7)))
...
int32_t main(void)
{
 ...
 USBD_Start();
  __NVIC_EnableIRQ(USBD_IRQn);
    ...
    u32TrimInit = (*((vu32 *) (((((uint32_t)0x40000000UL) + 0x00000UL)+0x118))));
    (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (4))));


    while (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID)
    {




        if ((((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->HIRCTRIMCTL & (0x3ul << (0))) != 0x1)
        {

            if (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS & (0x1ul << (4)))
            {
                ...
                ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->HIRCTRIMCTL = (0x1 << (10))
                                   | (0x1 << (0))
                                   | (0x0 << (4))
                                   | (0x1 << (9))
                                   | (10 << (16));
        ...
        if (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->HIRCTRIMSTS & ((0x1ul << (2)) | (0x1ul << (1))))
        {

            (*((vu32 *) (((((uint32_t)0x40000000UL) + 0x00000UL)+0x118)))) = u32TrimInit;


            ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->HIRCTRIMCTL = 0;


            ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->HIRCTRIMSTS = (0x1ul << (2)) | (0x1ul << (1));
