...
# 78 "../../../../Library/StdDriver/src/usbd.c"
void USBD_Open(const S_USBD_INFO_T *param, CLASS_REQ pfnClassReq, SET_INTERFACE_REQ pfnSetInterface)
{
    g_USBD_sINFO = param;
...
# 106 "../../../../Library/StdDriver/src/usbd.c"
void USBD_Start(void)
{
...
# 128 "../../../../Library/StdDriver/src/usbd.c"
void USBD_GetSetupPacket(uint8_t *buf)
{
    USBD_MemCopy(buf, g_USBD_au8SetupPacket, 8ul);
}
# 143 "../../../../Library/StdDriver/src/usbd.c"
void USBD_ProcessSetupPacket(void)
{
...
# 198 "../../../../Library/StdDriver/src/usbd.c"
...
# 358 "../../../../Library/StdDriver/src/usbd.c"
void USBD_StandardRequest(void)
{
                                        ;
...
# 588 "../../../../Library/StdDriver/src/usbd.c"
void USBD_PrepareCtrlIn(uint8_t pu8Buf[], uint32_t u32Size)
{
                                               ;
...
# 623 "../../../../Library/StdDriver/src/usbd.c"
void USBD_CtrlIn(void)
{
...
# 683 "../../../../Library/StdDriver/src/usbd.c"
void USBD_PrepareCtrlOut(uint8_t *pu8Buf, uint32_t u32Size)
{
...
# 701 "../../../../Library/StdDriver/src/usbd.c"
void USBD_CtrlOut(void)
{
    if (s_USBD_u32CtrlOutToggle != (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EPSTS0 & 0xf0))
    {
        s_USBD_u32CtrlOutToggle = ((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EPSTS0 & 0xf0; //keep H/W 1ul toggle status
...
# 740 "../../../../Library/StdDriver/src/usbd.c"
void USBD_SwReset(void)
{
    uint32_t i;
...
# 770 "../../../../Library/StdDriver/src/usbd.c"
void USBD_SetVendorRequest(VENDOR_REQ pfnVendorReq)
{
    g_USBD_pfnVendorRequest = pfnVendorReq;
}
# 784 "../../../../Library/StdDriver/src/usbd.c"
void USBD_SetConfigCallback(SET_CONFIG_CB pfnSetConfigCallback)
{
    g_USBD_pfnSetConfigCallback = pfnSetConfigCallback;
}
# 800 "../../../../Library/StdDriver/src/usbd.c"
void USBD_LockEpStall(uint32_t u32EpBitmap)
{
