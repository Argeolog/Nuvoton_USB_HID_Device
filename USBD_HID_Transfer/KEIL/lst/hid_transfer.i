...
# 691 "C:\\Keil_v5\\ARM\\ARMCLANG\\Bin\\..\\include\\arm_acle.h" 3
...
void Veri_Gonder(void);
void Gelen_Data(uint8_t *pu8EpBuf, uint32_t u32Size);
...
{
    uint32_t u32IntSts = ((uint32_t)(((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS));
    uint32_t u32State = ((uint32_t)(((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->ATTR & 0x300f));

    //------------------------------------------------------------------
    if (u32IntSts & (0x1ul << (2)))
    {
        // Floating detect
        (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (2))));

        if (((uint32_t)(((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->VBUSDET & (0x1ul << (0)))))
        {

            ((uint32_t)(((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->ATTR |= 0x7D0));
        }
        else
        {

            ((uint32_t)(((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->ATTR &= ~(0x1ul << (7))));
        }
    }
    ...
    if (u32IntSts & (0x1ul << (0)))
    {
        ...
        (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (0))));
        ...
        if (u32State & (0x1ul << (1)))
        {
            ...
            ((uint32_t)(((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->ATTR &= ~(0x1ul << (4))));
        }
...
# 93 "../hid_transfer.c"
    ...
    if (u32IntSts & (0x1ul << (3)))
    {
        ...
        (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (3))));
    ...
    if (u32IntSts & (0x1ul << (1)))
    {
        ...
        if (u32IntSts & (0x1ul << (31)))
        {
            ...
            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (31))));


            (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].CFGP + (uint32_t)((0ul) << 4))) |= (0x1ul << (0)));
            (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].CFGP + (uint32_t)((1ul) << 4))) |= (0x1ul << (0)));
        ...
        if (u32IntSts & (0x1ul << (16)))
        {
            ...
            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (16))));
            // control IN
            USBD_CtrlIn();
        }
        ...
        if (u32IntSts & (0x1ul << (17)))
        {
            ...
            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (17))));
        ...
        if (u32IntSts & (0x1ul << (18)))
        {
            ...
            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (18))));
            // Interrupt IN
            EP2_Handler();
        }
        ...
        if (u32IntSts & (0x1ul << (19)))
        {
            ...
            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (19))));
            // Interrupt OUT
            EP3_Handler();
        }
        ...
        if (u32IntSts & (0x1ul << (20)))
        {
            ...
            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (20))));
        }

        if (u32IntSts & (0x1ul << (21)))
        {

            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (21))));
        }

        if (u32IntSts & (0x1ul << (22)))
        {

            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (22))));
        }

        if (u32IntSts & (0x1ul << (23)))
        {

            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (23))));
        }

        if (u32IntSts & (0x1ul << (24)))
        {

            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (24))));
        }

        if (u32IntSts & (0x1ul << (25)))
        {

            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (25))));
        }

        if (u32IntSts & (0x1ul << (26)))
        {

            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (26))));
        }

        if (u32IntSts & (0x1ul << (27)))
        {

            (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->INTSTS = ((0x1ul << (27))));
        }
    }
}
...
{
    uint8_t *pu8Ptr;
    pu8Ptr = (uint8_t *)((((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL)+0x100ul) + ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].BUFSEG + (uint32_t)((3ul) << 4)))));
    Gelen_Data(pu8Ptr, ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((3ul) << 4)))));
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((3ul) << 4))) = (64));
...
void HID_Init(void)
{
    ...
    ((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->STBUFSEG = 0;
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].CFG + (uint32_t)((0ul) << 4))) = ((0x1ul << (9)) | (2ul << (5)) | 0));
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].BUFSEG + (uint32_t)((0ul) << 4))) = ((0 + 8)));
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].CFG + (uint32_t)((1ul) << 4))) = ((0x1ul << (9)) | (1ul << (5)) | 0));
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].BUFSEG + (uint32_t)((1ul) << 4))) = ((0 + 8)));
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].CFG + (uint32_t)((2ul) << 4))) = ((2ul << (5)) | 0x01));
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].BUFSEG + (uint32_t)((2ul) << 4))) = (((0 + 8) + 8)));
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].CFG + (uint32_t)((3ul) << 4))) = ((1ul << (5)) | 0x02));
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].BUFSEG + (uint32_t)((3ul) << 4))) = ((((0 + 8) + 8) + 64)));
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((3ul) << 4))) = (64));
}

void HID_ClassRequest(void) // Bu Fonksiyon Windows Haberlesmesi ile ilgili. Örnegin Usb Takildigi Anda " SET_IDLE " Olusur.
{
    uint8_t buf[8];
       ...
       switch (buf[1])
        {
            case 0x02:
            {
                (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((1ul) << 4))) = (buf[6]));
        ...
        switch (buf[1])
        {
            case 0x09:
            {
                if (buf[3] == 3)
                {
                    ...
                    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].CFG + (uint32_t)((1ul) << 4))) |= (0x1ul << (7)));
                    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((1ul) << 4))) = (0));
                }
            ...
            case 0x0A:
            {
                ...
                (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((0ul) << 4))) = (0));
                break;
            }
...
void Veri_Gonder()
{
        uint8_t s_au8TestPages[64];
        s_au8TestPages[0]=12; // Veriler Bununla Gönderilir.
     s_au8TestPages[1]=13;
        s_au8TestPages[2]=14;
    s_au8TestPages[3]=15;
        USBD_MemCopy((uint8_t *)((((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL)+0x100ul) + ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].BUFSEG + (uint32_t)((2ul) << 4))))), (void *)s_au8TestPages, 64);
        (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((2ul) << 4))) = (64));
